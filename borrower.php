													...
													<div class="modal-content">
														...
														<div class="modal-body">
															...
															<div class="form-group">
																...
																<input type="tel" name="contact_no" value="<?php echo $fetch['contact_no']?>" class="form-control" placeholder="Eg.[09065 567 654]" pattern=""  />
															</div>
															<div class="form-group">
																<label>Address</label>
			...
			<form method="POST" action="save_borrower.php">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label>Contact no</label>
							<input type="tel" name="contact_no" class="form-control" placeholder="Eg.[09065 567 654]" maxlength="11"   />
						</div>
						<div class="form-group">
							<label>Address</label>
